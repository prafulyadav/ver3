...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit speedflow</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">User</a></li>
                                <li class="breadcrumb-item active">speedflow</li>
                            </ol>
                        </div>
            ...
            <!-- end page title -->
            <?php
            $query = "SELECT * FROM  speedflow where id='$todo' ";
...
$uploads_dir = 'uploads';
        ...
        move_uploaded_file($tmp_name, "$uploads_dir/$new_file_name");*/
                            ...
                            if ($status == "OK") {
                                $qb = mysqli_query($con, "update speedflow set port_title='$service_title',  port_detail='$service_detail' where id='$todo'");
