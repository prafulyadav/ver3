                                    ...
                                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab" aria-selected="false">
                                                <i class="fas fa-home"></i> New EDI FAQ
                                            </a>
                                        </li>
...
if($status=="OK")
{
$qf=mysqli_query($con,"INSERT INTO blog (blog_title, blog_desc) VALUES ('$blog_title', '$blog_desc')");
   ...
   ?>
              <form action="" method="post" enctype="multipart/form-data">
                                              ...
                                              <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">Short FAQ Description</label>
