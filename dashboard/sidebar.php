            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarPot" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarLanding">
                        <i class="ri-rhythm-fill"></i> <span data-key="t-landing">Manage speedflow</span>
                    </a>
                    <div class="menu-dropdown collapse" id="sidebarPot" style="">
                        <ul class="nav nav-sm flex-column">
                            <!-- <li class="nav-item">
                                        <a href="createportfolio" class="nav-link" data-key="t-one-page"> update  </a>
                                    </li> -->
                            <li class="nav-item">
                                <a href="speedflow.php" class="nav-link" data-key="t-nft-landing"> speedflow List </a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarSl" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarLanding">
                        <i class="ri-image-fill"></i> <span data-key="t-landing">Manage tech page</span>
                    </a>
                    <div class="menu-dropdown collapse" id="sidebarSl" style="">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="tech-page.php" class="nav-link" data-key="t-nft-landing">  technology page Banner</a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarw" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarLanding">
                        <i class="ri-message-line"></i> <span data-key="t-landing">Manage logo</span>
                    </a>
                    <div class="menu-dropdown collapse" id="sidebarw" style="">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="listTlogo.php" class="nav-link" data-key="t-one-page">list tool logos</a>
                            </li>
                            <li class="nav-item">
                                <a href="addTlogo.php" class="nav-link" data-key="t-nft-landing"> add tool logos</a>
                            </li> 
                            <li class="nav-item">
                                <a href="listClogo.php" class="nav-link" data-key="t-nft-landing"> list customer logos </a>
                            </li>
                            <li class="nav-item">
                                <a href="addClogo.php" class="nav-link" data-key="t-nft-landing"> add customer logos </a>
                            </li>
                        </ul>
                    </div>
                </li>
